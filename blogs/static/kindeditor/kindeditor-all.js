...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'	background-images:url(' + themesPath + 'common/flash.gif);',
		...
		'img.ke-rm {',
		'	border:1px solid #AAA;',
		'	background-images:url(' + themesPath + 'common/rm.gif);',
		'	background-position:center center;',
		'	background-repeat:no-repeat;',
		'	width:100px;',
		'	height:100px;',
		...
		'img.ke-media {',
		'	border:1px solid #AAA;',
		'	background-images:url(' + themesPath + 'common/media.gif);',
		'	background-position:center center;',
		'	background-repeat:no-repeat;',
		'	width:100px;',
		'	height:100px;',
...
_plugin('core', function(K) {
	...
	_each('link,images,flash,media,anchor'.split(','), function(i, name) {
			...
			for (var i = 0; i < rows; i++) {
				...
				for (var j = 0; j < cols; j++) {
					...
					var span = K('<span class="ke-img"></span>')
						...
						.css('background-images', 'url(' + path + 'static.gif)');
					cell.append(span);
					elements.push(cell);
					num++;
				}
...
KindEditor.plugin('multiimage', function(K) {
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			uploadUrl : K.addParam(uploadJson, 'dir=images'),
